...
[assembly: InternalsVisibleTo("Lithnet.ResourceManagement.Client.Core.Test")]
    ...
    public static class ResourceManagementSchema
    {
        ...
        internal static void RefreshSchema(EndpointManager e)
        {
            try
            {
                ...
                var set = ResourceManagementSchema.GetMetadataSet(e);
        ...
        private static MetadataSet GetMetadataSet(EndpointManager e)
        {
            ...
            MetadataExchangeClient mex = new MetadataExchangeClient(httpBinding, e.MetadataEndpoint);
            ...
            if (responseMessage.IsFault)
            {
                ...
                throw new FaultException(fault, "Get");
            }
