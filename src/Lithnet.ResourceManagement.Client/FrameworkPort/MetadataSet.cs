...
namespace Lithnet.ResourceManagement.Client
{
    ...
    public class MetadataSet : IXmlSerializable
    {
        ...
        void IXmlSerializable.ReadXml(XmlReader reader)
        {
            ...
            this._sections = metadataSet.MetadataSections;
            this._attributes = metadataSet.Attributes;
        }
...
#pragma warning disable
    ...
    internal class XmlSerializationReaderMetadataSet : System.Xml.Serialization.XmlSerializationReader
    {
        ...
        public bool ProcessOuterElement
        {
            get
            {
                return _processOuterElement;
            }
            set
            {
                _processOuterElement = value;
            }
        }
        ...
        private MetadataSet Read67_MetadataSet(bool isNullable, bool checkType)
        {
            ...
            MetadataSet o;
            o = new MetadataSet();
            global::System.Collections.ObjectModel.Collection<MetadataSection> a_0 = (global::System.Collections.ObjectModel.Collection<MetadataSection>)o.@MetadataSections;
        ...
        private MetadataSection Read66_MetadataSection(bool isNullable, bool checkType)
        {
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None)
            {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    {
                        o.@Metadata = (MetadataReference)ReadSerializable((System.Xml.Serialization.IXmlSerializable)System.Activator.CreateInstance(typeof(MetadataReference), System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic, null, new object[0], null));
                        paramsRead[3] = true;
                    }
    ...
    internal class XmlSerializerContract : global::System.Xml.Serialization.XmlSerializerImplementation
    {
        ...
        {
            if (type == typeof(MetadataSet)) return true;
            return false;
        }
        public override System.Xml.Serialization.XmlSerializer GetSerializer(System.Type type)
        {
            if (type == typeof(MetadataSet)) return new MetadataSetSerializer();
            return null;
        }
    }
